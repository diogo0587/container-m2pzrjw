...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-m2pzrjw.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-m2pzrjw.containers.anotherwebservice.com/
...
```
git clone git@github.com:diogo0587/container-m2pzrjw.git
cd container-m2pzrjw
```
...
```
docker attach container-m2pzrjw
```
